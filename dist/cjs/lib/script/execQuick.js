    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, function (execFn, inputObject) {
                    ...
                    return __awaiter(this, void 0, void 0, function () {
                        var execScript, evalResult, jsonResultMatch, resultMatchStr, jsonResultStr, resultObj, responseStr;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                ...
                                case 1:
                                    ...
                                    if (jsonResultMatch) {
                                        resultMatchStr = jsonResultMatch.map(function (s) { return s; })[0];
                                        jsonResultStr = resultMatchStr.replace("####=", "").replace("=####", "");
                                        resultObj = {};
                                        try {
                                            resultObj = JSON.parse(jsonResultStr);
                                        }
                                        catch (err) { }
                                        responseStr = evalResult.response.replace("*** Script: [DEBUG] " + resultMatchStr, "");
                                        return [2 /*return*/, {
                                                "result": resultObj,
